        ...
        <div className={`submenu ${sticky ? 'submenu_sticky' : ''}`}>
          <div className="submenu__inner">
            <Tabs value={router.asPath} onChange={(route) => router.push(route)}>
              ...
              <Tabs.Item label="Estudiantes" value="/estudiantes" />
              <Tabs.Item label="Cursos" value="/cursos" />
              <Tabs.Item label="Matricula" value="/matricula" />
              <Tabs.Item label="Reportes" value="/reportes" />
            </Tabs>
          </div>
        </div>
      </nav>
